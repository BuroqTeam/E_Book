...
public class Game3Controller1User : MonoBehaviour
{
    ...
    public void CreateCards()
    {
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            obj.transform.GetComponent<CardController1User>().Index = i;
            obj.transform.GetComponent<CardController1User>().CardIndex = 1;
            obj.transform.GetComponent<CardController1User>().Str = Str1.StrGroup[i];
        ...
        for (int i = 0; i < 8; i++)
        {
            ...
            obj.transform.GetComponent<CardController1User>().Index = i;
            obj.transform.GetComponent<CardController1User>().CardIndex = 2;
            obj.transform.GetComponent<CardController1User>().Str = Str2.StrGroup[i];
            obj.transform.GetComponent<CardController1User>().Game3Controller = this;
            StrId++;
        }
    ...
    public void LocationCards()
    {
        ...
        for (int i = 0; i < Collection.Count; i++)
        {
            ...
            Collection[i].transform.GetComponent<CardController1User>().LocationObj = CardLocations.transform.GetChild(i).gameObject;
    ...
    public IEnumerator StartCard()
    {
        ...
        Cursor.GetComponent<CursorControl1User>().SelectObjects();
    }
    ...
    public void AddNewCard()
    {
        if (EmptyLocation.Count >= 1 && AdditionEmptyLocation.Count % 2 == 0)
        {
            ...
            Collection[Collection.Count - 1].GetComponent<CardController1User>().LocationObj = EmptyLocation[r1];
            ...
            obj1.transform.GetComponent<CardController1User>().Index = StrId;
            obj1.transform.GetComponent<CardController1User>().CardIndex = 2;
            obj1.transform.GetComponent<CardController1User>().Str = Str2.StrGroup[StrId / 2];
            obj1.transform.GetComponent<CardController1User>().Game3Controller = this;
            Collection.Add(Cards.transform.GetChild(Cards.transform.childCount - 1).gameObject);
            ...
            Collection[Collection.Count - 1].GetComponent<CardController1User>().LocationObj = EmptyLocation[r2];
            ...
            StartCoroutine(obj1.transform.GetComponent<CardController1User>().AddCardFeedback());
            GameObject _particle1 = Instantiate(AddCardParticle, ParticleLocations.transform);
            _particle1.transform.DOScale(0.38f, 0);
            _particle1.transform.DOMove(Collection[Collection.Count - 1].GetComponent<CardController1User>().LocationObj.transform.position, 0);
            StrId = StrId + 2;
        }
        else if (EmptyLocation.Count < 1 && AdditionEmptyLocation.Count % 2 == 0)
        {
            ...
            Collection[Collection.Count - 1].GetComponent<CardController1User>().LocationObj = AdditionEmptyLocation[r1];
            ...
            Collection[Collection.Count - 1].GetComponent<CardController1User>().LocationObj = AdditionEmptyLocation[r2];
    ...
    public IEnumerator ChangeStr()
    {
        ...
        for (int i = 0; i < Collection.Count; i++)
        {
            StartCoroutine(Collection[i].GetComponent<CardController1User>().CloseDoor());
        }
        Collection[0].GetComponent<CardController1User>().DoorFeedback.PlayFeedbacks();
        yield return new WaitForSeconds(0.4f);

        //Listga sort qilib olish
        for (int i = 0; i < Collection.Count; i++)
        {
            if (Collection[i].GetComponent<CardController1User>().CardIndex == 1)
            {
        ...
        for (int i = 0; i <= Card1Collection.Count / 2; i++)
        {
            ...
            //Card1 uchun shufle
            string _newStr = Card1Collection[i].GetComponent<CardController1User>().Str;
            int _newIndex = Card1Collection[i].GetComponent<CardController1User>().Index;
            Card1Collection[i].GetComponent<CardController1User>().Str = Card1Collection[Card1Collection.Count - (i + 1)].GetComponent<CardController1User>().Str;
            Card1Collection[i].transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().text = Card1Collection[i].GetComponent<CardController1User>().Str;
            ...
            Card2Collection[Card2Collection.Count - (i + 1)].GetComponent<CardController1User>().Index = _newIndex1;
        }
        ...
        for (int i = 0; i < Collection.Count; i++)
        {
            StartCoroutine(Collection[i].GetComponent<CardController1User>().OpenDoor());
        }
        Collection[0].GetComponent<CardController1User>().DoorFeedback.PlayFeedbacks();
        yield return new WaitForSeconds(1f);
    ...
    public void Result()
    {
        ...
        {
            if ((SelectObjects[0].GetComponent<CardController1User>().CardIndex != SelectObjects[1].GetComponent<CardController1User>().CardIndex)
                && (SelectObjects[0].GetComponent<CardController1User>().Index == SelectObjects[1].GetComponent<CardController1User>().Index))
            {
                //Correct Particle
                for (int i = 0; i < 2; i++)
                {
                    ...
                    _particle.transform.DOMove(SelectObjects[i].GetComponent<CardController1User>().LocationObj.transform.position, 0);
                    SelectObjects[i].GetComponent<CardController1User>().Correct();
                }
                ...
                for (int i = 0; i < SelectObjects.Count; i++)
                {
                    ...
                    SelectObjects[i].GetComponent<CardController1User>().LocationObj.GetComponent<CardLocation>().IHave = false;
            ...
            {
                StartCoroutine(SelectObjects[0].GetComponent<CardController1User>().Wrong());
                StartCoroutine(SelectObjects[1].GetComponent<CardController1User>().Wrong());
            }
        }
        for (int i = 0; i < 2; i++)
        {
