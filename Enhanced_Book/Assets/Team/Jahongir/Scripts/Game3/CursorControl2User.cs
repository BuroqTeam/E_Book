...
public class CursorControl2User : MonoBehaviour
{
    public Game3Conroller2User Game3Control;
    ...
    public void SelectObjects()
    {
        ...
        {
            if (Object1.GetComponent<CardController2User>().Index == Game3Control.Collection[i].GetComponent<CardController2User>().Index && i != 5)
            {
